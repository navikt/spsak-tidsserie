package no.nav.spsak.tidsserie;
...
public class LocalDateIntervalTest {
    ...
    public void skal_splitte_intervall_på_lik_grense_fom_tom() throws Exception {
        ...
        Assertions.assertThat(splittet).isEqualTo(int2.splitAll(int1)); // symmetrisk splitt

        Assertions.assertThat(splittet).containsExactly(
    ...
    public void skal_dele_opp_intervall_når_det_trekkes_fra_annet() throws Exception {
        ...
        Assertions.assertThat(splittet).isNotEqualTo(int2.splitAll(int1)); // ikke symmetrisk splitt

        Assertions.assertThat(splittet).containsExactly(new LocalDateInterval(d1, d1));
    }
    ...
    public void skal_dele_opp_intervall_når_det_trekkes_fra_annet_i_midten() throws Exception {
        ...
        Assertions.assertThat(splittet).containsExactly(new LocalDateInterval(d1, d1), new LocalDateInterval(d2, d2));
    }
    ...
    public void skal_dele_opp_intervall_når_det_trekkes_fra_annet_fra_start() throws Exception {
        ...
        Assertions.assertThat(splittet).containsExactly(new LocalDateInterval(d4.plusDays(1), d2));
    }
